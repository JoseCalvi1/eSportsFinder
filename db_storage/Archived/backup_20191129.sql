...
INSERT INTO `esf_game_profiles` (`id`, `id_user`, `id_game`, `id_team`, `name`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	(1, 2, 1, 31, 'aromeroCoD', 'Slayer', '3h', 'Afternoon', 2, '2019-10-23 14:14:10', 0, '2019-11-29 10:31:09', 0),
	...
	(6, 3, 2, 0, 'jcalviLoL', 'Support', '2-4h', 'Afternoon', 5, '0000-00-00 00:00:00', 0, '2019-11-29 10:41:06', 0),
	(8, 2, 2, 0, 'aromeroLoL', 'Slayer', '3h', 'Afternoon', 2, '2019-10-23 14:14:10', 0, '2019-11-28 10:39:54', 0),
	(13, 6, 2, 32, 'Dani2033', 'Jungle', 'Menos de 2 horas', 'Mañana | Tarde | Noche', 6, '2019-11-29 10:23:07', 0, '2019-11-29 10:25:18', 0);
...
-- Volcando datos para la tabla esportsfinder_v2.esf_messages: ~21 rows (aproximadamente)
...
-- Volcando datos para la tabla esportsfinder_v2.esf_teams: ~6 rows (aproximadamente)
...
INSERT INTO `esf_teams` (`id`, `id_game`, `id_captain`, `name`, `team_tag`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	...
	(32, 2, 6, 'SeVacia', 'SS', 'Illo, que sevacia', 'Entre 2 y 4 horas', 'Mañana | Tarde | ', 6, '2019-11-29 10:25:18', 0, '2019-11-29 10:25:37', 0);
