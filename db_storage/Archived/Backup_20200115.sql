...
INSERT INTO `esf_game_profiles` (`id`, `id_user`, `id_game`, `id_team`, `name`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	...
	(10, 3, 2, 0, 'King JoseCalvi', 'Support', 'Menos de dos horas', 'Noche |  | ', 3, '2020-01-08 13:13:39', 0, '2020-01-08 13:13:39', 0);
...
-- Volcando datos para la tabla esportsfinder_v2.esf_teams: ~1 rows (aproximadamente)
