...
-- Volcando datos para la tabla esportsfinder_v2.esf_game_profiles: ~3 rows (aproximadamente)
...
INSERT INTO `esf_game_profiles` (`id`, `id_user`, `id_game`, `id_team`, `name`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	...
	(5, 5, 1, NULL, 'jcalvi2', 'Objective', '2-4h', 'Afternoon', 0, '0000-00-00 00:00:00', 0, '2019-11-07 13:06:42', 0);
...
-- Volcando datos para la tabla esportsfinder_v2.esf_messages: ~7 rows (aproximadamente)
...
INSERT INTO `esf_teams` (`id`, `id_game`, `name`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	...
	(5, 2, 'FNATIC', 'FNTC', '5h', 'Afternoon', 0, '2019-10-18 11:56:56', 0, '2019-11-08 14:35:42', 0),
	(6, 2, 'G2 Esports', 'G2', '6h', 'Morning', 0, '2019-10-18 11:56:56', 0, '2019-11-08 14:35:36', 0);
