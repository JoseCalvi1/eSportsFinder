...
INSERT INTO `esf_game_profiles` (`id`, `id_user`, `id_game`, `id_team`, `name`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	(1, 2, 1, 0, 'aromeroCoD', 'Slayer', '3h', 'Afternoon', 2, '2019-10-23 14:14:10', 0, '2019-11-19 17:57:17', 0),
	...
	(8, 2, 2, 33, 'aromeroLoL', 'Slayer', '3h', 'Afternoon', 2, '2019-10-23 14:14:10', 0, '2019-11-19 16:28:11', 0);
...
-- Volcando datos para la tabla esportsfinder_v2.esf_messages: ~12 rows (aproximadamente)
...
-- Volcando datos para la tabla esportsfinder_v2.esf_teams: ~7 rows (aproximadamente)
DELETE FROM `esf_teams`;
/*!40000 ALTER TABLE `esf_teams` DISABLE KEYS */;
INSERT INTO `esf_teams` (`id`, `id_game`, `name`, `team_tag`, `description`, `play_time`, `availability`, `created_by`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	(1, 1, 'Pain Gaming', 'PAIN', '', '2h', 'Afternoon', 3, '2019-10-18 11:56:56', 2, '2019-11-19 13:45:20', 0),
	(2, 1, 'Gaints Gaming', 'GIA', '', '4h', 'Night', 0, '2019-10-18 11:56:56', 2, '2019-11-19 13:45:21', 0),
	(3, 1, 'Team Heretics', 'HTCS', '', '2h-4h', 'Afternoon', 0, '2019-10-18 11:56:56', 3, '2019-11-19 13:45:22', 0),
	(4, 1, 'Movistar Riders', 'MRDS', '', '2h', 'Morning', 0, '2019-10-18 11:56:56', 3, '2019-11-19 13:45:23', 0),
	(5, 2, 'FNATIC', 'FNTC', '', '5h', 'Afternoon', 3, '2019-10-18 11:56:56', 2, '2019-11-19 13:45:24', 0),
	(6, 2, 'G2 Esports', 'G2', '', '6h', 'Morning', 0, '2019-10-18 11:56:56', 3, '2019-11-19 13:45:25', 0),
	(31, 1, 'PaVe Gaming', 'PaVe', 'Esta es la descripción del equipo', 'Entre 2 y 4 horas', NULL, 2, '2019-11-19 16:23:38', 0, '2019-11-19 16:23:38', 0),
	(33, 2, 'LoL Team', 'LooL', 'Este es el equipo de lol', 'Entre 2 y 4 horas', NULL, 2, '2019-11-19 16:28:11', 0, '2019-11-19 16:28:11', 0);
...
INSERT INTO `esf_users` (`id`, `name`, `email`, `user_name`, `password`, `active`, `last_visit_date`, `date_entered`, `modified_by`, `date_modified`, `deleted`) VALUES
	...
	(6, 'Daniel Rubio', 'daniel.rubio@tourismoptimizerplatform.com', 'danie', '$1$wO9zDhUa$2PJt6X31No1o.XMuSgxcz1', 1, '2019-10-04 13:47:13', '2019-10-04 13:47:14', 1, '2019-10-04 13:47:45', 0);
