...
foreach ($scrims as $scrim) { ?>
    <div class="col-12">
        <div class="card-message">
            <h4 class="info-title"><?php echo $scrim->subject ?></h4>
            <h6><?php echo $this->helper->translate('LBL_FROM') . ' ' . $scrim->name . ' ' . $this->helper->translate('LBL_AT') . ' ' . $scrim->date_modified ?></h6>
            <p><?php echo $scrim->message ?></p>
            <a data-toggle="modal" href="#myModal" data-target="#edit-modal-<?php echo $scrim->id; ?>"
               id="<?php echo $scrim->id; ?>">
                <i class="material-icons">chat</i><?php echo $this->helper->translate('Message', 'LBL_REPLY'); ?></a>
        </div>
    </div>

    <div id="edit-modal-<?php echo $scrim->id; ?>" class="modal fade" tabindex="-1" role="dialog"
                ...
                <form action="<?php echo $this->helper->url("Message", "sendMessage"); ?>" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subject" name="message[subject]" required
                               value="RE: <?php echo $scrim->subject ?>">
                    </div>
                    <div class="form-group">
