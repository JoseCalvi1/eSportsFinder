...
<div class="container">
    ...
    <form action="<?php echo $this->helper->url("User", "register"); ?>" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="user[name]" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,64}" title="Formato de nombre incorrecto" required value="<?php echo $user['name'];?>">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" name="user[email]" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,})$" title="Formato de correo erróneo" required value="<?php echo $user['email'];?>">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="user_name" name="user[user_name]" pattern="^([a-zA-Z0-9]){5,12}$" title="Logintud de 5 a 12 caracteres entre letras y números" required value="<?php echo $user['user_name'];?>">
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="password" name="user[password]" pattern="[A-Za-z0-9!?-_]{8,12}" title="Letras mayúsculas, minúsculas, números y los caracteres !?-_ Su tamaño: entre 8 y 12 caracteres." required>
        ...
        <div class="form-group">
            ...
            <input required type="password" class="form-control" id="rep_password" name="user[rep_password]">
