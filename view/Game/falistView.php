        ...
        <table class="table table-bordered table-striped" id="mytable">
            ...
            <?php foreach ($users as $user) { ?>
                <tr>
                    ...
                    <td><a data-toggle="modal" href="#myModal" data-target="#edit-modal-<?php echo $user->id; ?>" id="<?php echo $user->id; ?>">
                            <i class="material-icons">chat</i></a></td>
                </tr>

                <div id="edit-modal-<?php echo $user->id; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content" style="padding: 10px;">
                            ...
                            <form action="<?php echo $this->helper->url("Message", "sendMessage"); ?>" method="POST"
                                ...
                                <input type="hidden" class="form-control" id="description" name="message[id_user_to]" required value="<?php echo $user->id_user ?>">
